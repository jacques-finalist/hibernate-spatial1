 ...
 */
public class TestMySQLStoreRetrieve {

    private final TestStoreRetrieve delegate;

    public TestMySQLStoreRetrieve() {
        DataSourceUtils dataSourceUtils = new DataSourceUtils("hibernate-spatial-mysql-test.properties", new MySQLExpressionTemplate());
        TestData testData = dataSourceUtils.getTestData();
        delegate = new TestStoreRetrieve(dataSourceUtils, testData, new MySQLGeometryEquality());
    }
