...
public class MultiMLineStringTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        mmsimple = new MultiMLineString(new MLineString[] {ml1}, 0.1, geomfactory);
    ...
    public void testGetGeometryType() {
        assertTrue( "wrong type reported", mm1.getGeometryType().equalsIgnoreCase("multimlinestring"));
    }
    ...
    /*
     * Class under test for boolean equalsExact(com.vividsolutions.jts.geom.Geometry, double)
     */
    ...
    /*
     * Class under test for void MultiLineString(com.vividsolutions.jts.geom.LineString[], com.vividsolutions.jts.geom.PrecisionModel, int)
     */
    ...
    /*
     * Class under test for void MultiLineString(com.vividsolutions.jts.geom.LineString[], com.vividsolutions.jts.geom.GeometryFactory)
     */
    ...
    public void testInterpolate() {
        ...
        assertTrue("co 1 not OK", Math.abs(((MCoordinate)ca[1]).m - 1.0) < 0.00001);
        assertTrue("co 2 not OK", Math.abs(((MCoordinate)ca[2]).m - 2.0) < 0.00001);
        assertTrue("co 3 not OK", Math.abs(((MCoordinate)ca[3]).m - (2.0 + mm1.getMGap())) < 0.00001);
        assertTrue("co 4 not OK", Math.abs(((MCoordinate)ca[4]).m - (4.0 + mm1.getMGap())) < 0.00001);
        
        double dist = mm1.getLength();
        dist += (mm1.getNumGeometries()-1)* mm1.getMGap();
        assertTrue("interpolation not consistent with distance", Math.abs(((MCoordinate)ca[4]).m -  dist) < 0.00001);
