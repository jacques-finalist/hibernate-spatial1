 ...
 * can be legally used, but credits go to the guys from Spring.
 *
 * @author janb
 */
...
public class GeoDBTestDataSourceFactory implements FactoryBean<Object> {
     ...
     * @param schemaLocation   the location of the file containing the schema DDL to export
     *                         to the database
     * @param testDataLocation the location of the file containing the test data to load into
     *                         the database
     */
