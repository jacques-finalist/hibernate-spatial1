 ...
 */
public class TestSqlServerStoreRetrieve {

    private final DataSourceUtils dataSourceUtils;
    private final TestStoreRetrieve delegate;
    private final TestData testData;

    public TestSqlServerStoreRetrieve() {
        this.dataSourceUtils = new DataSourceUtils("hibernate-spatial-sqlserver-test.properties", new SQLServerExpressionTemplate());
        this.testData = dataSourceUtils.getTestData();
        this.delegate = new TestStoreRetrieve(dataSourceUtils, testData);
    }
