 ...
 */
public class TestSqlServerSpatialRestrictions {

    private static Logger LOGGER = LoggerFactory.getLogger(TestSqlServerSpatialRestrictions.class);
    ...
    public TestSqlServerSpatialRestrictions() {
