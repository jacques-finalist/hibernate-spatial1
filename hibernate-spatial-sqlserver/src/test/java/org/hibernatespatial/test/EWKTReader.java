/**
 * This file is a version of JTS WKTReader that is modified to add support
 * for MGeometry objects. The changes have been made by Martin Steinwender (Prisma Solutions)
 * and Karel Maesen (Geovise).
 *
 *
