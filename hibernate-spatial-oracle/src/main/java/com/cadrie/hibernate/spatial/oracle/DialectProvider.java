...
public class DialectProvider implements SpatialDialectProvider {
	...
	/* (non-Javadoc)
	 * @see com.cadrie.hibernate.spatial.spi.SpatialDialectProvider#createSpatialDialect(java.lang.String, java.util.Map)
	 */
	public SpatialDialect createSpatialDialect(String dialect, Map map) {

		if (dialect.equals ("com.cadrie.hibernate.spatial.oracle.OracleSpatial9Dialect") ||
			dialect.equals("org.hibernate.dialect.Oracle9Dialect") ||
			dialect.equals(OracleSpatial9Dialect.SHORT_NAME) )
		    return new OracleSpatial9Dialect();
		else 
		    return null;
	    }
