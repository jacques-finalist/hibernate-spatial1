...
public class OracleSpatial10gDialect extends Oracle9Dialect implements
    ...
    private class SpatialRelateFunction extends StandardSQLFunction {
        ...
        public String render(final List args,
            ...
            return isOGCStrict() ? getOGCSpatialRelateSQL(
                    (String) args.get(0), (String) args.get(1), this.relation)
    ...
    public String getSpatialAnalysisSQL(List args,
            int spatialAnalysisFunction, boolean useFilter) {
    ...
    public String[] getFeatures() {
        return this.features.keySet()
                .toArray(new String[this.features.size()]);
    }
    ...
    private void configure() {
        ...
        URL propfile = loader.getResource(getClass().getCanonicalName());
        if (propfile != null) {
            InputStream is = null;
